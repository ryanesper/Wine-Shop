...
<body>
  ...
  <div id="wrapper">
    ...
    <header id="header-container">
	    <!-----START Top Nav Bar----->
	    <ul id="nav-bar">
	      <li><a id="nocolor" href="#">Home</a></li>
	    ...
	    <!-----START Your Account----->
	    <a id="youraccount" href="#">Your Account</a>
	    <!-----END Your Account----->
	...
	<div id="content-container">
	   ...
	   <ul id="loginmenu">
	      <li><a id="loginnocolor" href="#">Home</a></li>
		  <li><a id="logincolor" href="#">Manufacturers</a></li>
	   </ul>
	   ...
	   <div id="productinformation">
           <div id="border">
              <div id="pdifpc1">
                  <img src="pics/1-brand.jpg">
              </div>
              <div id="pdifpc2">
                  <h3>Aliquam diam</h3>
                  <p>Pellentesque aliquam orci magna, nec volutpat ante. Proin luctus mollis gravida. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer...</p>
              </div>   
           </div>
           <div id="border">
              <div id="pdifpc1">
           ...
           <div id="border">
              ...
              <div id="pdifpc2">
                  <h3>Aliquam diam</h3>
                  <p>Pellentesque aliquam orci magna, nec volutpat ante. Proin luctus mollis gravida. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer...</p3>
                  <p></p>
              </div>
           </div>
           <div id="border">
	      ...
	      <div id="rightcolumnbox">
		     ...
		     <div id="specialcontainer">
		        <div id="specialsmallpicture">
				   <a href=""><img src="pics/pic8small.jpg"></a>
				</div>
		  ...
		  <div id="rightcolumnbox2">
             ...
             <div id="topsellercontainer">
                <div>
				   ...
				   <a href="#"><img src="pics/pic1small.jpg"></a>
				   <div>
				...
				<div>
				   <a href="#"><img src="pics/pic3small.jpg"></a>	
				   <div>
				      <h5>Lorem ipsum dolor sit...</h5>	
   				      <h3>You have to try on our..</h3>					  
				   </div>				   
				...
				<div>
				   <a href="#"><img src="pics/pic5small.jpg"></a>			
				   <div>
				      <h5>Lorem ipsum dolor sit...</h5>	
				      <h3>You have to try on our..</h3>					  
				   </div>				   
